 ...
 *申报科研项目窗口
 */
public class AddScientificProjectFrame extends JFrame{
	/**
	 * 
	 */
	private static final long serialVersionUID = 1L;

	public AddScientificProjectFrame(String title) {
...
///////////////////////////////////////////////////////////////////////////
		submitBtn.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				String department = pYuanXiJTF.getText();
				...
				boolean state = ProjectDao.addDB(p);
				if(state == true) {
