...
///////////////////////////////////////////////////////////////////////////
		...
		JLabel pCreateTimeJL = new JLabel("申报时间：");
		pCreateTimeJL.setFont(font);
		pCreateTimeJL.setForeground(Color.blue);
		pCreateTimeJL.setBounds(50, 250, 100, 30);

		//时间
		final JTextField pCreateTimeJTF = new JTextField();
		pCreateTimeJTF.setBounds(150,  250,  200,  30);
...
///////////////////////////////////////////////////////////////////////////
		...
		pCreateTimeJTF.setText(p.getCreateTime().toString());
		...
		submitBtn.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				Project p = new Project(new Integer(proNo), proName, new Integer(teacherNo), teacherName, 
						department, proType, proForm, createTime, content, memo, checked, pass);
